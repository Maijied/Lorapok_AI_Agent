---
description: description: The master operational workflow for AI agents working on the Lorapok AI Agent repository. Defines testing, documentation sync, and MCP usage.
---

# 🪐 Lorapok AI Workflow: Lorapok AI Agent
