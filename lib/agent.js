...
class LorapokCodingAgent {
    ...
    async callPerplexityAPI(messages, model, options = {}) {
        ...
        const targetUrl = isOpenRouter ? this.openrouterBaseUrl : this.perplexityBaseUrl;
        ...
        try {
            ...
            if (status === 401) {
                ...
                const provName = isOpenRouter ? 'OpenRouter (https://openrouter.ai/keys)' : 'Perplexity (https://www.perplexity.ai/settings/api)';
